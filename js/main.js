    ...
    document.querySelectorAll(".tabs-trigger__item").forEach((item) =>
      item.addEventListener('click', function (e) {
        ...
        document.querySelectorAll('.tabs-trigger__item').forEach((child) => child.classList.remove(
          'tabs-trigger__item--active'));
        document.querySelectorAll('.tabs-content__item').forEach((child) => child.classList.remove(
